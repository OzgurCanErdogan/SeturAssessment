...
namespace ReportApplication.Services
{
    public class ReportService : IReportService
    {
        ...
        public ReportService(IConfiguration configuration)
        {
            ...
            //var factory = new ConnectionFactory() { HostName = "localhost", Port = int.Parse("5672") };
            try
            {
        ...
        public void PublishNewReportDetails(ReportDetailsPublishedDto reportPublishedDto)
        {
